...
Proof.
  ...
  Case "s = cons". simpl. rewrite -> IHs. simpl. reflexivity. Qed.
...
Proof.
  ...
  Case "l = cons". simpl. rewrite -> rev_snoc. rewrite -> IHl.
  reflexivity. Qed.  
...
Proof.
  ...
  Case "l1 = cons". simpl. rewrite -> IHl1. reflexivity. Qed.
(** [] *)
...
Definition filter_even_gt7 (l : list nat) : list nat :=
  filter (fun a =>  (andb (negb (ble_nat a 6)) (evenb a))) l.
